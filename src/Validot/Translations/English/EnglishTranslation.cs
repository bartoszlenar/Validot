namespace Validot.Translations
{
    ...
    public static partial class Translation
    {
        public static IReadOnlyDictionary<string, string> English { get; } = new Dictionary<string, string>
        {
            ...
            [MessageKey.Collections.MinCollectionSize] = "Must contain at least {min} items",
            [MessageKey.Collections.MaxCollectionSize] = "Must contain at most {max} items",
            ...
            [MessageKey.Numbers.GreaterThan] = "Must be greater than {min}",
            [MessageKey.Numbers.GreaterThanOrEqualTo] = "Must be greater than or equal to {min}",
            [MessageKey.Numbers.LessThan] = "Must be less than {max}",
            [MessageKey.Numbers.LessThanOrEqualTo] = "Must be less than or equal to {max}",
            ...
            [MessageKey.Times.After] = "Must be after than {min}",
            [MessageKey.Times.AfterOrEqualTo] = "Must be after than or equal to {min}",
            [MessageKey.Times.Before] = "Must be before than {max}",
            [MessageKey.Times.BeforeOrEqualTo] = "Must be before than or equal to {max}",
            ...
            [MessageKey.TimeSpanType.GreaterThan] = "Must be greater than {min}",
            [MessageKey.TimeSpanType.GreaterThanOrEqualTo] = "Must be greater than or equal to {min}",
            [MessageKey.TimeSpanType.LessThan] = "Must be less than {max}",
            [MessageKey.TimeSpanType.LessThanOrEqualTo] = "Must be less than or equal to {max}",

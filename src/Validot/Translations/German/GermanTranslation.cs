namespace Validot.Translations
{
    ...
    public static partial class Translation
    {
        public static IReadOnlyDictionary<string, string> German { get; } = new Dictionary<string, string>
        {
            ...
            [MessageKey.Collections.MinCollectionSize] = "Muss mindestens {min} Elemente haben",
            [MessageKey.Collections.MaxCollectionSize] = "Muss maximal {max} Elemente haben",
            ...
            [MessageKey.Times.After] = "Muss nach dem {min} liegen",
            [MessageKey.Times.AfterOrEqualTo] = "Muss danach oder zum gleichen Zeitpunkt sein wie {min}",
            [MessageKey.Times.Before] = "Muss vor dem {max} liegen",
            [MessageKey.Times.BeforeOrEqualTo] = "Muss davor oder zum gleichen Zeitpunkt sein wie {max}",
            ...
            [MessageKey.TimeSpanType.GreaterThan] = "Muss größer sein als {min}",
            [MessageKey.TimeSpanType.GreaterThanOrEqualTo] = "Muss größer als oder gleich sein wie {min}",
            [MessageKey.TimeSpanType.LessThan] = "Muss kleiner sein als {max}",
            [MessageKey.TimeSpanType.LessThanOrEqualTo] = "Muss kleiner als oder gleich sein wie {max}",

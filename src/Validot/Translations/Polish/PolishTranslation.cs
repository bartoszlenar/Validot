namespace Validot.Translations
{
    ...
    public static partial class Translation
    {
        public static IReadOnlyDictionary<string, string> Polish { get; } = new Dictionary<string, string>
        {
            ...
            [MessageKey.Collections.MinCollectionSize] = "Musi zawierać minimalnie {min} elementów",
            [MessageKey.Collections.MaxCollectionSize] = "Musi zawierać maksymalnie {max} elementów",
            ...
            [MessageKey.Numbers.GreaterThan] = "Musi być większe od {min}",
            [MessageKey.Numbers.GreaterThanOrEqualTo] = "Musi być większe od lub równe {min}",
            [MessageKey.Numbers.LessThan] = "Musi być mniejsze od {max}",
            [MessageKey.Numbers.LessThanOrEqualTo] = "Musi być mniejsze od lub równe {max}",
            ...
            [MessageKey.Times.After] = "Musi być później niż {min}",
            [MessageKey.Times.AfterOrEqualTo] = "Musi być później niż lub równe {min}",
            [MessageKey.Times.Before] = "Musi być wcześniej niż {max}",
            [MessageKey.Times.BeforeOrEqualTo] = "Musi być wcześniej niż lub równe {max}",
            ...
            [MessageKey.TimeSpanType.GreaterThan] = "Musi być większe od {min}",
            [MessageKey.TimeSpanType.GreaterThanOrEqualTo] = "Musi być większe od lub równe {min}",
            [MessageKey.TimeSpanType.LessThan] = "Musi być mniejsze od {max}",
            [MessageKey.TimeSpanType.LessThanOrEqualTo] = "Musi być mniejsze od lub równe {max}",

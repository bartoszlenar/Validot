namespace Validot.Translations
{
    ...
    public static partial class Translation
    {
        public static IReadOnlyDictionary<string, string> Portuguese { get; } = new Dictionary<string, string>
        {
            ...
            [MessageKey.Collections.MinCollectionSize] = "Deve conter no mínimo {min} elementos",
            [MessageKey.Collections.MaxCollectionSize] = "Deve conter no máximo {max} elementos",
            ...
            [MessageKey.Times.After] = "Deve ser posterior a {min}",
            [MessageKey.Times.AfterOrEqualTo] = "Deve ser igual ou posterior a {min}",
            [MessageKey.Times.Before] = "Deve ser anterior a {max}",
            [MessageKey.Times.BeforeOrEqualTo] = "Deve ser igual ou anterior a {max}",
            ...
            [MessageKey.TimeSpanType.GreaterThan] = "Deve ser maior que {min}",
            [MessageKey.TimeSpanType.GreaterThanOrEqualTo] = "Deve ser maior ou igual que {min}",
            [MessageKey.TimeSpanType.LessThan] = "Deve ser menor que {max}",
            [MessageKey.TimeSpanType.LessThanOrEqualTo] = "Deve ser menor ou igual que {max}",

namespace Validot.Translations
{
    ...
    public static partial class Translation
    {
        public static IReadOnlyDictionary<string, string> Russian { get; } = new Dictionary<string, string>
        {
            ...
            [MessageKey.Collections.MinCollectionSize] = "Должен содержать не менее {min} элементов",
            [MessageKey.Collections.MaxCollectionSize] = "Должен содержать не более {max} элементов",
            ...
            [MessageKey.Times.After] = "Должно быть позже, чем {min}",
            [MessageKey.Times.AfterOrEqualTo] = "Должно быть позже или равно {min}",
            [MessageKey.Times.Before] = "Должно быть раньше, чем {max}",
            [MessageKey.Times.BeforeOrEqualTo] = "Должно быть раньше или равно {max}",
            ...
            [MessageKey.TimeSpanType.GreaterThan] = "Должно быть больше, чем {min}",
            [MessageKey.TimeSpanType.GreaterThanOrEqualTo] = "Должно быть больше или равно {min}",
            [MessageKey.TimeSpanType.LessThan] = "Должно быть меньше, чем {max}",
            [MessageKey.TimeSpanType.LessThanOrEqualTo] = "Должно быть меньше или равно {max}",

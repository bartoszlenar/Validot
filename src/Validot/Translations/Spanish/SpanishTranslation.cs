namespace Validot.Translations
{
    ...
    public static partial class Translation
    {
        public static IReadOnlyDictionary<string, string> Spanish { get; } = new Dictionary<string, string>
        {
            ...
            [MessageKey.Collections.MinCollectionSize] = "Debe contener como mínimo {min} elementos",
            [MessageKey.Collections.MaxCollectionSize] = "Debe contener como máximo {max} elementos",
            ...
            [MessageKey.Times.After] = "Debe ser posterior a {min}",
            [MessageKey.Times.AfterOrEqualTo] = "Debe ser igual o posterior a {min}",
            [MessageKey.Times.Before] = "Debe ser anterior a {max}",
            [MessageKey.Times.BeforeOrEqualTo] = "Debe ser igual o anterior a {max}",
            ...
            [MessageKey.TimeSpanType.GreaterThan] = "Debe ser mayor que {min}",
            [MessageKey.TimeSpanType.GreaterThanOrEqualTo] = "Debe ser mayor o igual que {min}",
            [MessageKey.TimeSpanType.LessThan] = "Debe ser menor que {max}",
            [MessageKey.TimeSpanType.LessThanOrEqualTo] = "Debe ser menor o igual que {max}",

...
internal class PathStack
{
    ...
    private readonly Stack<int> _indexesLevelsStack = new(DefaultCollectionsCapacity);

    private readonly Stack<string> _indexesStack = new(DefaultCollectionsCapacity);

    private readonly Stack<string> _stack = new(DefaultCollectionsCapacity);

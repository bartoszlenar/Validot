namespace Validot.Tests.Unit.Rules.Collections
{
    ...
    {
        private static readonly Func<int[], int[]> Convert = array => array;
        ...
        public void ExactCollectionSize_Should_CollectError(int[] model, int size, bool expectedIsValid)
        {
        ...
        public void NotEmptyCollection_Should_CollectError(int[] model, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        public void EmptyCollection_Should_CollectError(int[] model, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.EmptyCollection(),
        ...
        public void MaxCollectionSize_Should_CollectError(int[] model, int max, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        public void MinCollectionSize_Should_CollectError(int[] model, int min, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        public void CollectionSizeBetween_Should_CollectError(int[] model, int min, int max, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,

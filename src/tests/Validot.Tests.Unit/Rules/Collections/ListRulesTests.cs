namespace Validot.Tests.Unit.Rules.Collections
{
    ...
    {
        private static readonly Func<int[], List<int>> Convert = array => array.ToList();
        ...
        public void ExactCollectionSize_Should_CollectError(List<int> model, int size, bool expectedIsValid)
        {
        ...
        {
            Tester.TestExceptionOnInit<List<int>>(
        ...
        public void NotEmptyCollection_Should_CollectError(List<int> model, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        public void EmptyCollection_Should_CollectError(List<int> model, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.EmptyCollection(),
        ...
        public void MaxCollectionSize_Should_CollectError(List<int> model, int max, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        public void MinCollectionSize_Should_CollectError(List<int> model, int min, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        public void CollectionSizeBetween_Should_CollectError(List<int> model, int min, int max, bool expectedIsValid)
        {
            Tester.TestSingleRule(
                model,

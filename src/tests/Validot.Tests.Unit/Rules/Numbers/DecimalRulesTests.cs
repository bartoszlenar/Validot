namespace Validot.Tests.Unit.Rules.Numbers
{
    ...
    {
        private static readonly Func<int, decimal> Convert = i => i;
        ...
        public static IEnumerable<object[]> EqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.EqualTo_Limits(decimal.MinValue, decimal.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(EqualTo_Should_CollectError_Data))]
        public void EqualTo_Should_CollectError(decimal model, decimal value, bool shouldBeValid)
        {
        ...
        [Theory]
        [MemberData(nameof(EqualTo_Should_CollectError_Data))]
        public void EqualTo_Should_CollectError_FromNullable(decimal model, decimal value, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.EqualTo(value),
                shouldBeValid,
                MessageKey.Numbers.EqualTo,
        ...
        public void NotEqualTo_Should_CollectError(decimal model, decimal value, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(NotEqualTo_Should_CollectError_Data))]
        public void NotEqualTo_Should_CollectError_FromNullable(decimal model, decimal value, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.NotEqualTo(value),
        ...
        public static IEnumerable<object[]> GreaterThan_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.GreaterThan_Limits(decimal.MinValue, decimal.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(GreaterThan_Should_CollectError_Data))]
        public void GreaterThan_Should_CollectError(decimal model, decimal min, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.GreaterThan(min),
        ...
        [Theory]
        [MemberData(nameof(GreaterThan_Should_CollectError_Data))]
        public void GreaterThan_Should_CollectError_FromNullable(decimal model, decimal min, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.GreaterThan(min),
        ...
        public static IEnumerable<object[]> GreaterThanOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.GreaterThanOrEqualTo_Limits(decimal.MinValue, decimal.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(GreaterThanOrEqualTo_Should_CollectError_Data))]
        public void GreaterThanOrEqualTo_Should_CollectError(decimal model, decimal min, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(GreaterThanOrEqualTo_Should_CollectError_Data))]
        public void GreaterThanOrEqualTo_Should_CollectError_FromNullable(decimal model, decimal min, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.GreaterThanOrEqualTo(min),
        ...
        public static IEnumerable<object[]> LessThan_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.LessThan_Limits(decimal.MinValue, decimal.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(LessThan_Should_CollectError_Data))]
        public void LessThan_Should_CollectError(decimal model, decimal max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.LessThan(max),
        ...
        [Theory]
        [MemberData(nameof(LessThan_Should_CollectError_Data))]
        public void LessThan_Should_CollectError_FromNullable(decimal model, decimal max, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.LessThan(max),
        ...
        public static IEnumerable<object[]> LessThanOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.LessThanOrEqualTo_Limits(decimal.MinValue, decimal.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(LessThanOrEqualTo_Should_CollectError_Data))]
        public void LessThanOrEqualTo_Should_CollectError(decimal model, decimal max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(LessThanOrEqualTo_Should_CollectError_Data))]
        public void LessThanOrEqualTo_Should_CollectError_FromNullable(decimal model, decimal max, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.LessThanOrEqualTo(max),
        ...
        public static IEnumerable<object[]> Between_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.Between_Limits(decimal.MinValue, decimal.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(Between_Should_CollectError_Data))]
        public void Between_Should_CollectError(decimal min, decimal model, decimal max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Between(min, max),
        ...
        [Theory]
        [MemberData(nameof(Between_Should_CollectError_Data))]
        public void Between_Should_CollectError_FromNullable(decimal min, decimal model, decimal max, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.Between(min, max),
        ...
        {
            return RulesHelper.GetTestDataCombined(
                NumbersTestData.Between_InvalidRange(Convert, decimal.MinValue, decimal.MaxValue));
        }

        [Theory]
        [MemberData(nameof(Between_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void Between_Should_ThrowException_When_MinLargerThanMax(decimal min, decimal max)
        {
            Tester.TestExceptionOnInit<decimal>(
                s => s.Between(min, max),
        ...
        [Theory]
        [MemberData(nameof(Between_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void Between_Should_ThrowException_When_MinLargerThanMax_FromNullable(decimal min, decimal max)
        {
            Tester.TestExceptionOnInit<decimal?>(
                s => s.Between(min, max),
                typeof(ArgumentException));
        ...
        public static IEnumerable<object[]> BetweenOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.BetweenOrEqualTo_Limits(decimal.MinValue, decimal.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_CollectError_Data))]
        public void BetweenOrEqualTo_Should_CollectError(decimal min, decimal model, decimal max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_CollectError_Data))]
        public void BetweenOrEqualTo_Should_CollectError_FromNullable(decimal min, decimal model, decimal max, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.BetweenOrEqualTo(min, max),
        ...
        public void BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax(decimal min, decimal max)
        {
            Tester.TestExceptionOnInit<decimal>(
        ...
        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax_FromNullable(decimal min, decimal max)
        {
            Tester.TestExceptionOnInit<decimal?>(
                s => s.BetweenOrEqualTo(min, max),
                typeof(ArgumentException));
        ...
        public static IEnumerable<object[]> NonZero_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.NonZero_Signed_Limits(decimal.MinValue, decimal.MaxValue));
        }

        [Theory]
        [MemberData(nameof(NonZero_Should_CollectError_Data))]
        public void NonZero_Should_CollectError(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonZero(),
        ...
        [Theory]
        [MemberData(nameof(NonZero_Should_CollectError_Data))]
        public void NonZero_Should_CollectError_FromNullable(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.NonZero(),
        ...
        public void Positive_Should_CollectError(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Positive(),
        ...
        [Theory]
        [MemberData(nameof(Positive_Should_CollectError_Data))]
        public void Positive_Should_CollectError_FromNullable(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.Positive(),
        ...
        public void NonPositive_Should_CollectError(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonPositive(),
        ...
        [Theory]
        [MemberData(nameof(NonPositive_Should_CollectError_Data))]
        public void NonPositive_Should_CollectError_FromNullable(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.NonPositive(),
        ...
        public void Negative_Should_CollectError(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Negative(),
        ...
        [Theory]
        [MemberData(nameof(Negative_Should_CollectError_Data))]
        public void Negative_Should_CollectError_FromNullable(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.Negative(),
        ...
        public void NonNegative_Should_CollectError(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonNegative(),
        ...
        [Theory]
        [MemberData(nameof(NonNegative_Should_CollectError_Data))]
        public void NonNegative_Should_CollectError_FromNullable(decimal model, bool shouldBeValid)
        {
            Tester.TestSingleRule<decimal?>(
                model,
                m => m.NonNegative(),

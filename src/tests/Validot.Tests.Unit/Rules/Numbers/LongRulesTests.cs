namespace Validot.Tests.Unit.Rules.Numbers
{
    ...
    {
        private static readonly Func<int, long> Convert = i => i;
        ...
        public static IEnumerable<object[]> EqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.EqualTo_Limits(long.MinValue, long.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(EqualTo_Should_CollectError_Data))]
        public void EqualTo_Should_CollectError(long model, long value, bool shouldBeValid)
        {
        ...
        [Theory]
        [MemberData(nameof(EqualTo_Should_CollectError_Data))]
        public void EqualTo_Should_CollectError_FromNullable(long model, long value, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.EqualTo(value),
                shouldBeValid,
                MessageKey.Numbers.EqualTo,
        ...
        public static IEnumerable<object[]> NotEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.NotEqualTo_Limits(long.MinValue, long.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(NotEqualTo_Should_CollectError_Data))]
        public void NotEqualTo_Should_CollectError(long model, long value, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(NotEqualTo_Should_CollectError_Data))]
        public void NotEqualTo_Should_CollectError_FromNullable(long model, long value, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.NotEqualTo(value),
        ...
        public void GreaterThan_Should_CollectError(long model, long min, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.GreaterThan(min),
        ...
        [Theory]
        [MemberData(nameof(GreaterThan_Should_CollectError_Data))]
        public void GreaterThan_Should_CollectError_FromNullable(long model, long min, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.GreaterThan(min),
        ...
        public static IEnumerable<object[]> GreaterThanOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.GreaterThanOrEqualTo_Limits(long.MinValue, long.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(GreaterThanOrEqualTo_Should_CollectError_Data))]
        public void GreaterThanOrEqualTo_Should_CollectError(long model, long min, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(GreaterThanOrEqualTo_Should_CollectError_Data))]
        public void GreaterThanOrEqualTo_Should_CollectError_FromNullable(long model, long min, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.GreaterThanOrEqualTo(min),
        ...
        public static IEnumerable<object[]> LessThan_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.LessThan_Limits(long.MinValue, long.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(LessThan_Should_CollectError_Data))]
        public void LessThan_Should_CollectError(long model, long max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.LessThan(max),
        ...
        [Theory]
        [MemberData(nameof(LessThan_Should_CollectError_Data))]
        public void LessThan_Should_CollectError_FromNullable(long model, long max, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.LessThan(max),
        ...
        public static IEnumerable<object[]> LessThanOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.LessThanOrEqualTo_Limits(long.MinValue, long.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(LessThanOrEqualTo_Should_CollectError_Data))]
        public void LessThanOrEqualTo_Should_CollectError(long model, long max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(LessThanOrEqualTo_Should_CollectError_Data))]
        public void LessThanOrEqualTo_Should_CollectError_FromNullable(long model, long max, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.LessThanOrEqualTo(max),
        ...
        public static IEnumerable<object[]> Between_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.Between_Limits(long.MinValue, long.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(Between_Should_CollectError_Data))]
        public void Between_Should_CollectError(long min, long model, long max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Between(min, max),
        ...
        [Theory]
        [MemberData(nameof(Between_Should_CollectError_Data))]
        public void Between_Should_CollectError_FromNullable(long min, long model, long max, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.Between(min, max),
        ...
        {
            return RulesHelper.GetTestDataCombined(
                NumbersTestData.Between_InvalidRange(Convert, long.MinValue, long.MaxValue));
        }

        [Theory]
        [MemberData(nameof(Between_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void Between_Should_ThrowException_When_MinLargerThanMax(long min, long max)
        {
            Tester.TestExceptionOnInit<long>(
                s => s.Between(min, max),
        ...
        [Theory]
        [MemberData(nameof(Between_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void Between_Should_ThrowException_When_MinLargerThanMax_FromNullable(long min, long max)
        {
            Tester.TestExceptionOnInit<long?>(
                s => s.Between(min, max),
                typeof(ArgumentException));
        ...
        public void BetweenOrEqualTo_Should_CollectError(long min, long model, long max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_CollectError_Data))]
        public void BetweenOrEqualTo_Should_CollectError_FromNullable(long min, long model, long max, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.BetweenOrEqualTo(min, max),
        ...
        public void BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax(long min, long max)
        {
            Tester.TestExceptionOnInit<long>(
        ...
        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax_FromNullable(long min, long max)
        {
            Tester.TestExceptionOnInit<long?>(
                s => s.BetweenOrEqualTo(min, max),
                typeof(ArgumentException));
        ...
        public static IEnumerable<object[]> NonZero_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.NonZero_Signed_Limits(long.MinValue, long.MaxValue));
        }

        [Theory]
        [MemberData(nameof(NonZero_Should_CollectError_Data))]
        public void NonZero_Should_CollectError(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonZero(),
        ...
        [Theory]
        [MemberData(nameof(NonZero_Should_CollectError_Data))]
        public void NonZero_Should_CollectError_FromNullable(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.NonZero(),
        ...
        public void Positive_Should_CollectError(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Positive(),
        ...
        [Theory]
        [MemberData(nameof(Positive_Should_CollectError_Data))]
        public void Positive_Should_CollectError_FromNullable(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.Positive(),
        ...
        public void NonPositive_Should_CollectError(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonPositive(),
        ...
        [Theory]
        [MemberData(nameof(NonPositive_Should_CollectError_Data))]
        public void NonPositive_Should_CollectError_FromNullable(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.NonPositive(),
        ...
        public void Negative_Should_CollectError(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Negative(),
        ...
        [Theory]
        [MemberData(nameof(Negative_Should_CollectError_Data))]
        public void Negative_Should_CollectError_FromNullable(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.Negative(),
        ...
        public void NonNegative_Should_CollectError(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonNegative(),
        ...
        [Theory]
        [MemberData(nameof(NonNegative_Should_CollectError_Data))]
        public void NonNegative_Should_CollectError_FromNullable(long model, bool shouldBeValid)
        {
            Tester.TestSingleRule<long?>(
                model,
                m => m.NonNegative(),

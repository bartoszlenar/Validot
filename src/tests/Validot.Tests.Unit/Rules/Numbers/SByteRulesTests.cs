namespace Validot.Tests.Unit.Rules.Numbers
{
    ...
    {
        private static readonly Func<int, sbyte> Convert = i => (sbyte)i;
        ...
        public static IEnumerable<object[]> EqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.EqualTo_Limits(sbyte.MinValue, sbyte.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(EqualTo_Should_CollectError_Data))]
        public void EqualTo_Should_CollectError(sbyte model, sbyte value, bool shouldBeValid)
        {
        ...
        [Theory]
        [MemberData(nameof(EqualTo_Should_CollectError_Data))]
        public void EqualTo_Should_CollectError_FromNullable(sbyte model, sbyte value, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.EqualTo(value),
                shouldBeValid,
                MessageKey.Numbers.EqualTo,
        ...
        public static IEnumerable<object[]> NotEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.NotEqualTo_Limits(sbyte.MinValue, sbyte.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(NotEqualTo_Should_CollectError_Data))]
        public void NotEqualTo_Should_CollectError(sbyte model, sbyte value, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(NotEqualTo_Should_CollectError_Data))]
        public void NotEqualTo_Should_CollectError_FromNullable(sbyte model, sbyte value, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.NotEqualTo(value),
        ...
        public static IEnumerable<object[]> GreaterThan_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.GreaterThan_Limits(sbyte.MinValue, sbyte.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(GreaterThan_Should_CollectError_Data))]
        public void GreaterThan_Should_CollectError(sbyte model, sbyte min, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.GreaterThan(min),
        ...
        [Theory]
        [MemberData(nameof(GreaterThan_Should_CollectError_Data))]
        public void GreaterThan_Should_CollectError_FromNullable(sbyte model, sbyte min, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.GreaterThan(min),
        ...
        public static IEnumerable<object[]> GreaterThanOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.GreaterThanOrEqualTo_Limits(sbyte.MinValue, sbyte.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(GreaterThanOrEqualTo_Should_CollectError_Data))]
        public void GreaterThanOrEqualTo_Should_CollectError(sbyte model, sbyte min, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(GreaterThanOrEqualTo_Should_CollectError_Data))]
        public void GreaterThanOrEqualTo_Should_CollectError_FromNullable(sbyte model, sbyte min, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.GreaterThanOrEqualTo(min),
        ...
        public static IEnumerable<object[]> LessThan_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.LessThan_Limits(sbyte.MinValue, sbyte.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(LessThan_Should_CollectError_Data))]
        public void LessThan_Should_CollectError(sbyte model, sbyte max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.LessThan(max),
        ...
        [Theory]
        [MemberData(nameof(LessThan_Should_CollectError_Data))]
        public void LessThan_Should_CollectError_FromNullable(sbyte model, sbyte max, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.LessThan(max),
        ...
        public static IEnumerable<object[]> LessThanOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.LessThanOrEqualTo_Limits(sbyte.MinValue, sbyte.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(LessThanOrEqualTo_Should_CollectError_Data))]
        public void LessThanOrEqualTo_Should_CollectError(sbyte model, sbyte max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(LessThanOrEqualTo_Should_CollectError_Data))]
        public void LessThanOrEqualTo_Should_CollectError_FromNullable(sbyte model, sbyte max, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.LessThanOrEqualTo(max),
        ...
        public static IEnumerable<object[]> Between_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.Between_Limits(sbyte.MinValue, sbyte.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(Between_Should_CollectError_Data))]
        public void Between_Should_CollectError(sbyte min, sbyte model, sbyte max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Between(min, max),
        ...
        [Theory]
        [MemberData(nameof(Between_Should_CollectError_Data))]
        public void Between_Should_CollectError_FromNullable(sbyte min, sbyte model, sbyte max, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.Between(min, max),
        ...
        {
            return RulesHelper.GetTestDataCombined(
                NumbersTestData.Between_InvalidRange(Convert, sbyte.MinValue, sbyte.MaxValue));
        }

        [Theory]
        [MemberData(nameof(Between_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void Between_Should_ThrowException_When_MinLargerThanMax(sbyte min, sbyte max)
        {
            Tester.TestExceptionOnInit<sbyte>(
                s => s.Between(min, max),
        ...
        [Theory]
        [MemberData(nameof(Between_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void Between_Should_ThrowException_When_MinLargerThanMax_FromNullable(sbyte min, sbyte max)
        {
            Tester.TestExceptionOnInit<sbyte?>(
                s => s.Between(min, max),
                typeof(ArgumentException));
        ...
        public static IEnumerable<object[]> BetweenOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.BetweenOrEqualTo_Limits(sbyte.MinValue, sbyte.MaxValue, 0));
        }

        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_CollectError_Data))]
        public void BetweenOrEqualTo_Should_CollectError(sbyte min, sbyte model, sbyte max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_CollectError_Data))]
        public void BetweenOrEqualTo_Should_CollectError_FromNullable(sbyte min, sbyte model, sbyte max, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.BetweenOrEqualTo(min, max),
        ...
        public void BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax(sbyte min, sbyte max)
        {
            Tester.TestExceptionOnInit<sbyte>(
        ...
        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax_FromNullable(sbyte min, sbyte max)
        {
            Tester.TestExceptionOnInit<sbyte?>(
                s => s.BetweenOrEqualTo(min, max),
                typeof(ArgumentException));
        ...
        public static IEnumerable<object[]> NonZero_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.NonZero_Signed_Limits(sbyte.MinValue, sbyte.MaxValue));
        }

        [Theory]
        [MemberData(nameof(NonZero_Should_CollectError_Data))]
        public void NonZero_Should_CollectError(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonZero(),
        ...
        [Theory]
        [MemberData(nameof(NonZero_Should_CollectError_Data))]
        public void NonZero_Should_CollectError_FromNullable(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.NonZero(),
        ...
        public void Positive_Should_CollectError(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Positive(),
        ...
        [Theory]
        [MemberData(nameof(Positive_Should_CollectError_Data))]
        public void Positive_Should_CollectError_FromNullable(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.Positive(),
        ...
        public void NonPositive_Should_CollectError(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonPositive(),
        ...
        [Theory]
        [MemberData(nameof(NonPositive_Should_CollectError_Data))]
        public void NonPositive_Should_CollectError_FromNullable(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.NonPositive(),
        ...
        public void Negative_Should_CollectError(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Negative(),
        ...
        [Theory]
        [MemberData(nameof(Negative_Should_CollectError_Data))]
        public void Negative_Should_CollectError_FromNullable(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.Negative(),
        ...
        public void NonNegative_Should_CollectError(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonNegative(),
        ...
        [Theory]
        [MemberData(nameof(NonNegative_Should_CollectError_Data))]
        public void NonNegative_Should_CollectError_FromNullable(sbyte model, bool shouldBeValid)
        {
            Tester.TestSingleRule<sbyte?>(
                model,
                m => m.NonNegative(),

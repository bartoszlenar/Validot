namespace Validot.Tests.Unit.Rules.Numbers
{
    ...
    {
        private static readonly Func<int, ulong> Convert = i => (ulong)i;
        ...
        public static IEnumerable<object[]> EqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.EqualTo_Limits(ulong.MinValue, ulong.MaxValue, 1UL));
        }

        [Theory]
        [MemberData(nameof(EqualTo_Should_CollectError_Data))]
        public void EqualTo_Should_CollectError(ulong model, ulong value, bool shouldBeValid)
        {
        ...
        [Theory]
        [MemberData(nameof(EqualTo_Should_CollectError_Data))]
        public void EqualTo_Should_CollectError_FromNullable(ulong model, ulong value, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.EqualTo(value),
                shouldBeValid,
                MessageKey.Numbers.EqualTo,
        ...
        public static IEnumerable<object[]> NotEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.NotEqualTo_Limits(ulong.MinValue, ulong.MaxValue, 1UL));
        }

        [Theory]
        [MemberData(nameof(NotEqualTo_Should_CollectError_Data))]
        public void NotEqualTo_Should_CollectError(ulong model, ulong value, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(NotEqualTo_Should_CollectError_Data))]
        public void NotEqualTo_Should_CollectError_FromNullable(ulong model, ulong value, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.NotEqualTo(value),
        ...
        public static IEnumerable<object[]> GreaterThan_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.GreaterThan_Limits(ulong.MinValue, ulong.MaxValue, 1UL));
        }

        [Theory]
        [MemberData(nameof(GreaterThan_Should_CollectError_Data))]
        public void GreaterThan_Should_CollectError(ulong model, ulong min, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.GreaterThan(min),
        ...
        [Theory]
        [MemberData(nameof(GreaterThan_Should_CollectError_Data))]
        public void GreaterThan_Should_CollectError_FromNullable(ulong model, ulong min, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.GreaterThan(min),
        ...
        public void GreaterThanOrEqualTo_Should_CollectError(ulong model, ulong min, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(GreaterThanOrEqualTo_Should_CollectError_Data))]
        public void GreaterThanOrEqualTo_Should_CollectError_FromNullable(ulong model, ulong min, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.GreaterThanOrEqualTo(min),
        ...
        public static IEnumerable<object[]> LessThan_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.LessThan_Limits(ulong.MinValue, ulong.MaxValue, 1UL));
        }

        [Theory]
        [MemberData(nameof(LessThan_Should_CollectError_Data))]
        public void LessThan_Should_CollectError(ulong model, ulong max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.LessThan(max),
        ...
        [Theory]
        [MemberData(nameof(LessThan_Should_CollectError_Data))]
        public void LessThan_Should_CollectError_FromNullable(ulong model, ulong max, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.LessThan(max),
        ...
        public void LessThanOrEqualTo_Should_CollectError(ulong model, ulong max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(LessThanOrEqualTo_Should_CollectError_Data))]
        public void LessThanOrEqualTo_Should_CollectError_FromNullable(ulong model, ulong max, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.LessThanOrEqualTo(max),
        ...
        public void Between_Should_CollectError(ulong min, ulong model, ulong max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Between(min, max),
        ...
        [Theory]
        [MemberData(nameof(Between_Should_CollectError_Data))]
        public void Between_Should_CollectError_FromNullable(ulong min, ulong model, ulong max, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.Between(min, max),
        ...
        {
            return RulesHelper.GetTestDataCombined(
                NumbersTestData.Between_InvalidRange(Convert, ulong.MinValue, ulong.MaxValue));
        }

        [Theory]
        [MemberData(nameof(Between_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void Between_Should_ThrowException_When_MinLargerThanMax(ulong min, ulong max)
        {
            Tester.TestExceptionOnInit<ulong>(
                s => s.Between(min, max),
        ...
        [Theory]
        [MemberData(nameof(Between_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void Between_Should_ThrowException_When_MinLargerThanMax_FromNullable(ulong min, ulong max)
        {
            Tester.TestExceptionOnInit<ulong?>(
                s => s.Between(min, max),
                typeof(ArgumentException));
        ...
        public static IEnumerable<object[]> BetweenOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.BetweenOrEqualTo_Limits(ulong.MinValue, ulong.MaxValue, 1UL));
        }

        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_CollectError_Data))]
        public void BetweenOrEqualTo_Should_CollectError(ulong min, ulong model, ulong max, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
        ...
        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_CollectError_Data))]
        public void BetweenOrEqualTo_Should_CollectError_FromNullable(ulong min, ulong model, ulong max, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.BetweenOrEqualTo(min, max),
        ...
        public void BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax(ulong min, ulong max)
        {
            Tester.TestExceptionOnInit<ulong>(
        ...
        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax_Data))]
        public void BetweenOrEqualTo_Should_ThrowException_When_MinLargerThanMax_FromNullable(ulong min, ulong max)
        {
            Tester.TestExceptionOnInit<ulong?>(
                s => s.BetweenOrEqualTo(min, max),
                typeof(ArgumentException));
        ...
        public static IEnumerable<object[]> NonZero_Should_CollectError_Data()
        {
            return RulesHelper.GetTestDataCombined(
                ...
                NumbersTestData.NonZero_Unsigned_Limits(ulong.MaxValue));
        }

        [Theory]
        [MemberData(nameof(NonZero_Should_CollectError_Data))]
        public void NonZero_Should_CollectError(ulong model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonZero(),
        ...
        [Theory]
        [MemberData(nameof(NonZero_Should_CollectError_Data))]
        public void NonZero_Should_CollectError_FromNullable(ulong model, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.NonZero(),
        ...
        public void Positive_Should_CollectError(ulong model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.Positive(),
        ...
        [Theory]
        [MemberData(nameof(Positive_Should_CollectError_Data))]
        public void Positive_Should_CollectError_FromNullable(ulong model, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.Positive(),
        ...
        public void NonPositive_Should_CollectError(ulong model, bool shouldBeValid)
        {
            Tester.TestSingleRule(
                model,
                m => m.NonPositive(),
        ...
        [Theory]
        [MemberData(nameof(NonPositive_Should_CollectError_Data))]
        public void NonPositive_Should_CollectError_FromNullable(ulong model, bool shouldBeValid)
        {
            Tester.TestSingleRule<ulong?>(
                model,
                m => m.NonPositive(),
